 ...
 *
 * <p>It adds support for some extra UI components and employs a hack to work around an existing bug
 * in the current version to get them all to work properly.
 *
