...
import static slogo.Frontend.ResourceUtil.*;
import slogo.Main;
...
public class TurtlePen implements DisplayPen {
  ...
  public static final String CONFIGURATION_RESOURCE_PATH = TurtlePen.class.getPackage().getClass().getPackageName() + "." + TurtlePen.class.getPackageName() + ".";
