 ...
 * This utility class was pulled from the spike slogo repository and was not written by this team
 */
public class ResourceUtil {
     ...
     *
     * NOTE, given resource value must represent a non-negative integer
     */
    public static int getResourceNumber (ResourceBundle resources, String key) throws InputMismatchException {
     ...
     *
     * NOTE, given resource value must represent the exact constant name in all capitals
     */
    public static Paint getResourceColor (ResourceBundle resources, String key) throws InputMismatchException {
     ...
     * Returns value of given resource as a number or throws an exception.
     *
     * NOTE, given resource value must represent the entire class name, including all packages
     */
    public static Shape getResourceShape (ResourceBundle resources, String key,
                                          int x, int y, int width, int height) throws InputMismatchException {
